          ...
          <div className="relative flex h-16 items-center justify-between">
                  ...
                  {"children" in item && item.children ? (
                    <>
                      ...
                      <div className="invisible absolute left-1/2 top-full z-50 mt-1 -translate-x-1/2 opacity-0 translate-y-1 transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:visible group-hover:opacity-100 group-hover:translate-y-0">
                        <div className="min-w-[200px] rounded-xl border border-hairline-neutral bg-surface p-1.5 shadow-soft">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span className="flex items-center justify-center size-4 sm:size-5 rounded-full bg-surface/15 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
      ...
      >
        <div className="flex items-center justify-between border-b border-hairline-neutral px-6 py-5">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex items-center justify-center size-10 rounded-lg border border-hairline-neutral bg-surface text-ink transition-colors hover:bg-fill-soft"
        ...
        <nav className="flex flex-col gap-1 px-4 py-6">
          ...
          >
            Tes Kelekatan
            <span className="flex items-center justify-center size-5 rounded-full bg-surface/15">
