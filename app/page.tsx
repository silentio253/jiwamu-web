...
function Connect() {
  ...
  return (
    <section className="bg-surface">
      <div className="mx-auto max-w-[900px] px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 text-center">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-normal tracking-tight text-ink text-balance">
          Mari terhubung!
        </h2>
...
function Subscribe() {
  return (
    <section className="bg-surface-alt">
      <div className="mx-auto max-w-[700px] px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 text-center">
        <p className="section-eyebrow">
          Berlangganan
        </p>
