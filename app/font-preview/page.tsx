...
function waLinkLocal(message: string): string {
    ...
    <section className="relative min-h-[100dvh] flex items-center overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] w-full px-4 sm:px-6 lg:px-8 pt-24 pb-20">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-6 text-[2.25rem] sm:text-5xl lg:text-6xl xl:text-7xl font-semibold leading-[1.05] tracking-tight text-ink">
            Ruang aman untuk{" "}
            <span
          ...
          <div className="mt-8 sm:mt-10 flex flex-wrap items-center gap-3">
            <Link
              href="/kelas"
              className="group inline-flex items-center gap-2.5 rounded-lg bg-accent px-5 sm:px-6 py-3 sm:py-3.5 text-sm sm:text-base font-medium text-white shadow-accent transition-all duration-300 hover:bg-accent-deep active:scale-[0.98] whitespace-nowrap"
            >
              Mulai Perjalananmu
              <span className="flex items-center justify-center size-6 rounded-full bg-white/15 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
            ...
            <Link
              ...
              className="inline-flex items-center rounded-lg border border-hairline-neutral bg-white px-5 sm:px-6 py-3 sm:py-3.5 text-sm sm:text-base font-medium text-ink transition-all hover:border-accent hover:bg-fill-soft whitespace-nowrap"
            >
              Tanya Kami
            </Link>
          </div>
    ...
    <section className="bg-white">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-40">
        <div className="max-w-[750px]">
          ...
          <p
            style={{ fontFamily: serif }}
            className="mt-8 sm:mt-10 text-xl sm:text-2xl lg:text-[2.25rem] font-normal text-ink leading-[1.4] text-pretty"
          >
          ...
          <div className="mt-10 sm:mt-12 pl-6 sm:pl-8 border-l-2 border-accent">
            <p
              style={{ fontFamily: serif }}
              className="text-lg sm:text-xl lg:text-2xl italic text-ink leading-relaxed text-pretty"
            >
...
function WhatYouNeedDynamic() {
  ...
  const items = [
    ...
    },
    {
      ...
      cta: "Jelajahi Buku",
      details:
        "Penerbit Jiwamu menerbitkan buku populer dan sastra psikologis. Ters juga Majalah Jiwamu bulanan ber-ISSN.",
    },
  ];
    ...
    <section className="bg-surface">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-32">
        <div className="max-w-2xl">
          <h2
            style={{ fontFamily: serif }}
            className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal tracking-tight text-ink text-balance"
          >
              ...
              >
                ...
                >
                  <div className="col-span-2 sm:col-span-1">
                    <span
                      style={{ fontFamily: serif }}
                      className="text-2xl sm:text-3xl lg:text-4xl italic text-accent"
                    >
                  ...
                  <div className="col-span-7 sm:col-span-8">
                    <h3
                      style={{ fontFamily: serif }}
                      className="text-lg sm:text-xl lg:text-2xl font-normal tracking-tight text-ink"
                    >
                      {item.title}
                    </h3>
                  ...
                  <div className="col-span-3 sm:col-span-2 text-right">
                    <span
                      className={`inline-flex items-center gap-1.5 text-sm font-medium text-accent transition-transform ${
                        isOpen ? "rotate-90" : ""
                      }`}
                    >
                      <ArrowRight weight="bold" className="size-3.5" />
      ...
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
          <div className="lg:col-span-5">
            ...
            <h2
              style={{ fontFamily: serif }}
              className="mt-4 sm:mt-5 text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal tracking-tight text-ink text-balance"
            >
            ...
            <div className="rounded-xl border border-hairline-neutral bg-surface p-6 sm:p-8 lg:p-10">
              <div className="grid grid-cols-3 gap-4 sm:gap-6">
                <div>
                  <p
                    style={{ fontFamily: serif }}
                    className="text-4xl sm:text-5xl lg:text-6xl text-ink"
                  >
                    11
                  </p>
        ...
        <div className="mt-10 sm:mt-14 rounded-xl border border-hairline-neutral overflow-hidden bg-white/50">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            <div className="hidden sm:flex items-center justify-center p-6 lg:p-8 border-l border-hairline-neutral">
              <p className="text-xs text-soft" style={{ fontFamily: serif }}>
                Bertumbuh Bersama
              </p>
            </div>
          </div>
  ...
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-[700px] px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-32 text-center">
        ...
        <h2
          style={{ fontFamily: serif }}
          className="mt-4 sm:mt-5 text-xl sm:text-2xl lg:text-3xl font-normal tracking-tight text-ink text-balance"
        >
